...
Gem::Specification.new do |s|
  s.name = %q{redis-retry}
  s.version = "0.1.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Matt Duncan"]
  s.date = %q{2010-04-15}
  s.description = %q{Adds a Redis::Retry class which can be used to proxy calls to Redis while
...
unavailable.
  ...
  s.summary = %q{Auto-retries Redis commands.}
  s.test_files = [
    "test/test_redis_retry.rb"
  ]
